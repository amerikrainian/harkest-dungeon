...
`curl -s --retry 60 --retry-connrefused --retry-delay 1 http://127.0.0.1:8771/health`. On any
bring-up oddity, confirm the responder is OURS - another process holding 8771 answers /health
while our own bind failed; grep the BepInEx log for `dev http:`.

...
namespace DD2A11y.Core.Strings {
    /// <summary>
    /// Plural-form selectors for translated count strings: a rule maps a count to the index of the
    /// form to speak, and a table value carries the forms '|'-separated ("{0} hour|{0} hours"). A
    /// translation file names its rule with the "_plural" key; English is the default. The rules are
    /// the CLDR categories folded to the handful of shapes the game's languages need.
    /// </summary>
    public static class PluralRules {
        ...
        /// unknown (the caller keeps English and reports it, so a typo never silently
        /// mis-pluralizes).</summary>

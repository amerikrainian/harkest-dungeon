...
namespace DD2A11y.Elements {
    /// <summary>
    /// The inspector's identity line: the boss blessing mark, the inspected combatant's name,
    /// HP, stress on heroes, and speed. The buffer carries death's door and the blessing
    ...
    public sealed class InspectorHeaderElement : UIElement {
        ...
        public override string Status {
            get {
                var actor = _actor();
                return actor != null && actor.IsOrdained ? S.StatusBlessed : null;
            }
        }
        ...
        public override string Label {
            get {
                var actor = _actor();
                return actor == null ? null : Actors.Name(actor);
            }
        }

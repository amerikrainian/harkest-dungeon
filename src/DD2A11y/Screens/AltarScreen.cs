...
namespace DD2A11y.Screens {
    ...
    /// then Embark. Enter on a region runs the game's own submit, which opens the region's
    /// sub-screen (read by its dedicated screen or the generic floor); Embark drives the
    /// game's own exit flow, including its spend-your-candles-first reminder dialog. Escape
